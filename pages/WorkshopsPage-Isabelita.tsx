...
export function WorkshopsPage({ onNavigate, user }: WorkshopsPageProps) {
  ...
  const handleSubmitEnrollment = () => {
    ...
    if (currentUser.role !== 'Estudiante') {
      updateUser(currentUser.id, { ...currentUser, role: 'Estudiante' });
    }
      ...
      <div className="pb-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div>
              <motion.div
                className="bg-gradient-to-b from-amber-50 to-slate-50 rounded-2xl border border-amber-200 p-6 shadow-lg sticky top-24"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.3 }}
              >
                <h3 className="text-lg font-bold text-slate-900 mb-4">Información</h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    />
                    <div>
                      <p className="text-sm font-semibold text-slate-900">Días con Talleres</p>
                      <p className="text-xs text-slate-600 mt-1">Los días en color dorado tienen talleres disponibles</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-1">Resaltado en azul para referencia</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    />
                    <div>
                      <p className="text-sm font-semibold text-slate-900">Sin Talleres</p>
                      <p className="text-xs text-slate-600 mt-1">Selecciona otro día para ver talleres</p>
                    </div>
                  </div>
                </div>

                <div className="mt-6 p-4 bg-white rounded-lg border border-amber-100">
                  <p className="text-xs font-semibold text-slate-700 mb-2">TOTAL DE TALLERES</p>
                  <p className="text-3xl font-bold" style={{ color: '#B8860B' }}>
                    {workshops?.length || 0}
                  </p>
                  <p className="text-xs text-slate-600 mt-2">talleres registrados</p>
                </div>
              </motion.div>
            </div>
          </div>
        ...
        >
          <div className="max-w-7xl mx-auto">
            <motion.p
              ...
              animate={{ opacity: 1 }}
            >
              Mostrando talleres para {new Date(selectedCalendarDate).toLocaleDateString('es-ES', { 
                weekday: 'long', 
                month: 'long', 
                day: 'numeric' 
              })}
      ...
      <div className="pb-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {((workshops && workshops.length > 0 ? workshops : defaultWorkshops)
              .filter((workshop: any) => {
                if (!selectedCalendarDate) return true;
                // Filtrar por fecha seleccionada en el calendario
                return workshop.date === selectedCalendarDate;
              })
              ...
              <motion.div
                ...
                whileHover={{ 
                  y: -12,
                  boxShadow: '0 20px 60px rgba(45, 75, 57, 0.2)',
              ...
              >
                ...
                <div className="p-8">
                  ...
                  {/* TÍTULO */}
                  <h3 
                    className="font-elegant text-2xl mb-4 leading-tight group-hover:text-[#B8860B] transition-colors duration-300"
                    style={{ color: '#2D4B39' }}
                  >
                    {workshop.title}
                  </h3>
                  ...
                  {/* DESCRIPCIÓN */}
                  <p className="text-sm mb-6 leading-relaxed line-clamp-3" style={{ color: '#6B7280' }}>
