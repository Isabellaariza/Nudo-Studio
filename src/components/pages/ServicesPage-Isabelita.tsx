...
export function ServicesPage({ onNavigate }: ServicesPageProps) {
  ...
  return (
    <div className="min-h-screen pt-8 pb-20 px-8 bg-gradient-to-br from-white via-[#E0D1C0]/10 to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="relative z-10 py-40 px-12">
            {/* Header */}
            <div className="text-center mb-8 max-w-2xl mx-auto">
              <h2 
                className="font-elegant tracking-wide mb-4 text-white text-[3.5rem]"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto pb-8">
              ...
              <motion.button
                type="submit"
                className="w-full py-4 px-8 text-white tracking-wide rounded-full overflow-hidden relative group flex items-center justify-center gap-2 mt-8"
        ...
        >
          <h2 
            className="font-elegant text-5xl tracking-wide mb-12 text-center" 
            style={{ color: '#2D4B39' }}
          >
            ¿Por Qué Elegirnos?
          </h2>
