  ...
  return (
    <div className="min-h-screen pt-8 pb-20 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h1 className="font-elegant text-[4rem] md:text-[5rem] tracking-wide mb-12" style={{ color: '#2D4B39' }}>
            Tu Carrito
          </h1>

          <div className="mb-6 p-4 rounded-lg border-l-4 border-[#B8860B] bg-[#FFF7E1]">
            ...
            <div className="lg:col-span-2 space-y-4">
              {cartItems.map((item) => (
                <motion.div
                  ...
                  className="bg-[#E0D1C0]/20 rounded-2xl p-6 flex gap-6"
                >
