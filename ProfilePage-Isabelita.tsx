    ...
    <div className="min-h-screen pt-8 pb-20 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <div className="bg-gradient-to-br from-[#E0D1C0]/30 to-[#E0D1C0]/10 rounded-3xl p-8 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                  <div className="flex items-center gap-6">
                    <div className="relative group">
                      <div className="w-32 h-32 rounded-full overflow-hidden shadow-xl border-4 border-white relative" style={{ backgroundColor: '#2D4B39' }}>
                      ...
                      <motion.button
                        ...
                        className="absolute -bottom-1 -right-1 w-10 h-10 bg-[#2D4B39] rounded-full flex items-center justify-center shadow-lg border-2 border-white opacity-0 group-hover:opacity-100 transition-all duration-300"
                    ...
                    <div>
                      <h1 className="font-elegant text-4xl lg:text-5xl tracking-wide mb-2" style={{ color: '#2D4B39' }}>
                        {activeUser?.name}
                      </h1>
                      ...
                      <p className="text-sm text-[#2D4B39]/60">Miembro desde {formatDate(activeUser?.joined)}</p>
                    </div>
                  </div>
                ...
                <div className="border-t border-[#2D4B39]/10 pt-6">
                      ...
                      >
                        <div className="space-y-4">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              <label className="flex items-center gap-2 mb-2 text-sm font-medium" style={{ color: '#2D4B39' }}>
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border border-[#E0D1C0] focus:border-[#B8860B] focus:ring-2 focus:ring-[#B8860B]/20 outline-none transition-all"
                              />
                            </div>
                            <div>
                              <label className="flex items-center gap-2 mb-2 text-sm font-medium" style={{ color: '#2D4B39' }}>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-[#B8860B]/10 rounded-full flex items-center justify-center">
                            <Mail className="w-5 h-5" style={{ color: '#B8860B' }} />
                          </div>
                          <div>
                            <p className="text-sm text-[#2D4B39]/60">Email</p>
                            <p className="text-[#2D4B39] font-medium">{activeUser?.email}</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-[#B8860B]/10 rounded-full flex items-center justify-center">
                          ...
                          <div>
                            <p className="text-sm text-[#2D4B39]/60">Teléfono</p>
                            <p className="text-[#2D4B39] font-medium">{activeUser?.phone}</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-[#B8860B]/10 rounded-full flex items-center justify-center">
                          ...
                          <div>
                            <p className="text-sm text-[#2D4B39]/60">Dirección</p>
                            <p className="text-[#2D4B39] font-medium">{activeUser?.address}</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-[#B8860B]/10 rounded-full flex items-center justify-center">
                          ...
                          <div>
                            <p className="text-sm text-[#2D4B39]/60">Documento</p>
                            <p className="text-[#2D4B39] font-medium">{getDocumentTypeLabel(activeUser?.documentType)}</p>
                            <p className="text-sm text-[#2D4B39]/70">{activeUser?.documentNumber}</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-[#B8860B]/10 rounded-full flex items-center justify-center">
                            <Package className="w-5 h-5" style={{ color: '#B8860B' }} />
                          </div>
                          <div>
                            <p className="text-sm text-[#2D4B39]/60">Pedidos</p>
                            <p className="text-xl font-semibold text-[#2D4B39]">{activeUser?.orders || 0}</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-[#B8860B]/10 rounded-full flex items-center justify-center">
                          ...
                          <div>
                            <p className="text-sm text-[#2D4B39]/60">Miembro desde</p>
                            <p className="text-[#2D4B39]">{formatDate(activeUser?.joined)}</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-[#2D4B39]/10 rounded-full flex items-center justify-center">
                            <User className="w-5 h-5" style={{ color: '#2D4B39' }} />
                          </div>
                          <div>
                            <p className="text-sm text-[#2D4B39]/60">Estado</p>
                            <p className="text-[#2D4B39]">{activeUser?.status ? 'Activo' : 'Inactivo'}</p>
                          </div>
                        </div>
                      </motion.div>
                    )}
