    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <h1 
                className="font-elegant text-[4rem] leading-tight mb-2"
                style={{ color: '#2D4B39' }}
              >
                Creaciones
              </h1>
              <h1 
                className="font-elegant text-[4rem] leading-tight mb-6"
                style={{ color: '#B8860B' }}
              >
                Únicas
              </h1>
            ...
            >
              <motion.div
                className="relative w-full max-w-[350px] aspect-[350/420] rounded-[2rem] overflow-hidden shadow-2xl"
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <motion.h2
            className="font-elegant text-2xl sm:text-3xl md:text-4xl lg:text-5xl tracking-wide mb-8"
            style={{ color: '#2D4B39' }}
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 
              className="font-elegant text-2xl sm:text-3xl md:text-4xl lg:text-5xl tracking-wide mb-4"
              style={{ color: '#2D4B39' }}
            >
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2 
              className="font-elegant text-2xl sm:text-3xl md:text-4xl lg:text-5xl tracking-wider mb-4"
              style={{ 
                color: '#2D4B39',
